codemaster@Money:~/worldbanc$ ls
README.md  private  public
codemaster@Money:~/worldbanc$ cd private
codemaster@Money:~/worldbanc/private$ ls
bin  cmd  contacts  customers  logs  passwords  transactions
codemaster@Money:~/worldbanc/private$ cd ..
codemaster@Money:~/worldbanc$ ls
README.md  private  public
codemaster@Money:~/worldbanc$ cd public
codemaster@Money:~/worldbanc/public$ ls
company_info.md  key.txt  pr_ideas.txt  products
codemaster@Money:~/worldbanc/public$ cat pr_ideas.txt
...
codemaster@Money:~/worldbanc/public$